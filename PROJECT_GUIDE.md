# Project guide — gen-final-testing
...
**`gencrew-gen-final-testing-dbt/`** — the dbt project, the stack chosen for
this delivery.

```bash
cd gencrew-gen-final-testing-dbt
...
Details per table: `gencrew-gen-final-testing-dbt/INCREMENTAL.md`.
...
Formulas and grains: `gencrew-gen-final-testing-dbt/KPI_CATALOG.md`.

## 6. Business rules

0 of 0 mapping-sheet rules were
applied automatically; the remainder are listed with reasons in
`gencrew-gen-final-testing-dbt/BUSINESS_RULES.md` for a human to resolve.
